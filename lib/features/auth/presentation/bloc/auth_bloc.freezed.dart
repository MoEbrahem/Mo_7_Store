...
abstract class _SignUpEvent implements AuthEvent {
  const factory _SignUpEvent(final String imageUrl) = _$SignUpEventImpl;
...
class _$ErrorStateImpl implements _ErrorState {
  const _$ErrorStateImpl({required this.errMessage});
...
abstract class _ErrorState implements AuthState {
  const factory _ErrorState({required final String errMessage}) =
      _$ErrorStateImpl;
